...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              people_ = new java.util.ArrayList<model.Person>();
              mutable_bitField0_ |= 0x00000001;
            }
            people_.add(
                input.readMessage(model.Person.PARSER, extensionRegistry));
            break;
          }
          default: {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return model.AddressBookProtos.internal_static_tutorial_AddressBook_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            model.AddressBook.class, model.AddressBook.Builder.class);
  }

  public static final int PEOPLE_FIELD_NUMBER = 1;
  private java.util.List<model.Person> people_;
  /**
   * <code>repeated .tutorial.Person people = 1;</code>
   */
  @java.lang.Override
  public java.util.List<model.Person> getPeopleList() {
    return people_;
  }
  /**
   * <code>repeated .tutorial.Person people = 1;</code>
   */
  @java.lang.Override
  public java.util.List<? extends model.PersonOrBuilder> 
   ...
   */
  @java.lang.Override
  public model.Person getPeople(int index) {
   ...
   */
  @java.lang.Override
  public model.PersonOrBuilder getPeopleOrBuilder(
      int index) {
    return people_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof model.AddressBook)) {
      return super.equals(obj);
    }
    model.AddressBook other = (model.AddressBook) obj;
  ...
  public static model.AddressBook parseFrom(
  ...
  public static model.AddressBook parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static model.AddressBook parseFrom(
  ...
  public static model.AddressBook parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static model.AddressBook parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static model.AddressBook parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(model.AddressBook prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using model.AddressBook.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public model.AddressBook getDefaultInstanceForType() {
      return model.AddressBook.getDefaultInstance();
    }

    @java.lang.Override
    public model.AddressBook build() {
      model.AddressBook result = buildPartial();
    ...
    @java.lang.Override
    public model.AddressBook buildPartial() {
      model.AddressBook result = new model.AddressBook(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof model.AddressBook) {
        return mergeFrom((model.AddressBook)other);
      } else {
    ...
    public Builder mergeFrom(model.AddressBook other) {
      if (other == model.AddressBook.getDefaultInstance()) return this;
      if (peopleBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      model.AddressBook parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (model.AddressBook) e.getUnfinishedMessage();
    ...
    private void ensurePeopleIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        people_ = new java.util.ArrayList<model.Person>(people_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        model.Person, model.Person.Builder, model.PersonOrBuilder> peopleBuilder_;
     ...
     */
    public Builder setPeople(
        int index, model.Person.Builder builderForValue) {
      if (peopleBuilder_ == null) {
        ensurePeopleIsMutable();
     ...
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public Builder addPeople(model.Person value) {
      if (peopleBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addPeople(
        model.Person.Builder builderForValue) {
      if (peopleBuilder_ == null) {
        ensurePeopleIsMutable();
    ...
    public Builder addAllPeople(
        java.lang.Iterable<? extends model.Person> values) {
      if (peopleBuilder_ == null) {
        ensurePeopleIsMutable();
     ...
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public model.Person.Builder getPeopleBuilder(
        int index) {
     ...
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public model.Person.Builder addPeopleBuilder() {
      return getPeopleFieldBuilder().addBuilder(
          model.Person.getDefaultInstance());
    }
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public model.Person.Builder addPeopleBuilder(
        int index) {
      return getPeopleFieldBuilder().addBuilder(
          index, model.Person.getDefaultInstance());
    }
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public java.util.List<model.Person.Builder> 
         getPeopleBuilderList() {
      return getPeopleFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        model.Person, model.Person.Builder, model.PersonOrBuilder> 
        getPeopleFieldBuilder() {
      if (peopleBuilder_ == null) {
  ...
  private static final model.AddressBook DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new model.AddressBook();
  }

  public static model.AddressBook getDefaultInstance() {
